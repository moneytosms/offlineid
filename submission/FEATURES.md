# OfflineID — Feature Reference (v1.3.0)
...
| Failure lockout | 30 s lockout after 5 consecutive rejections |
...
| Fill-light activation | Screen brightness → maximum; 4 white overlay panels frame the face oval at **< 22 lux** (configurable) |
| Fill-light deactivation | Hysteresis: turns off at **35 lux** (configurable) to avoid flicker |
...
## 8. Configurable Preferences (v1.3.0)

All preferences persist across app restarts.

| Preference | Default | Where |
|---|---|---|
| Lux activation threshold | 22 lux | Settings → Display |
| Lux deactivation threshold | 35 lux | Settings → Display |
