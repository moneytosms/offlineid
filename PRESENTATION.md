...
- React Native 0.75; native Kotlin (Android) + Swift (iOS).
- Drops into Datalake 3.0: register package, import 3 screens, add SyncBadge, call `initModels()`. Zero backend changes.
...
- Green Android debug APK built end-to-end.
